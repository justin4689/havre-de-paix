...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $rooms = [
            ...
            [
                'slug' => 'chambre-familiale-1',
                'name' => 'Chambre Familiale 1',
                'category' => 'familiale',
                'description_short' => 'Salon séparé, comptoir bar et baignoire : le grand confort en famille — jusqu\'à 4 personnes.',
                'description_long' => "<div>La <strong>Chambre Familiale 1</strong> est l'hébergement le plus spacieux du Havre de Paix : salon séparé, comptoir bar, chambre king size et salle de bain avec baignoire. Idéale en famille ou pour une occasion spéciale, jusqu'à 4 personnes.</div><h2>Ce qui la distingue</h2><ul><li>Salon séparé et comptoir bar</li><li>Salle de bain avec baignoire</li><li>Capacité 2–4 personnes</li></ul>",
            ...
            [
                'slug' => 'chambre-familiale-2',
                'name' => 'Chambre Familiale 2',
                'category' => 'familiale',
                'description_short' => 'Deux chambres réunies en duplex avec salon commun : la formule idéale pour 4 personnes.',
                'description_long' => '<div>La <strong>Chambre Familiale 2</strong>, en duplex, réunit deux chambres et un salon commun : chacun son espace, un seul toit. La formule idéale entre amis ou en famille, pour 4 personnes.</div><h2>Ce qui le distingue</h2><ul><li>2 chambres standard</li><li>Salon commun</li><li>Capacité 4 personnes</li></ul>',
                'capacity_adults' => 4, 'capacity_children' => 0,
