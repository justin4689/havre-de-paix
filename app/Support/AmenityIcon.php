...
/**
 * Source unique de vérité pour les icônes d'équipements :
 * utilisée par le composant Blade <x-amenity-icon> (site public)
 * et sérialisée en JSON pour la détection dynamique côté admin.
 */
class AmenityIcon
{
    /** Mot-clé (en minuscules) => icône. Premier match gagne. */
    ...
    {
        return self::PATHS[self::iconFor($name)];
    }
}
