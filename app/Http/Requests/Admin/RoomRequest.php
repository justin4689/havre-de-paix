...
class RoomRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'category'          => 'required|in:standard,premium,suite,suite-premium,duplex',
            ...
            'price_high_season'    => 'nullable|integer|min:1000',
            'price_weekend_low'    => 'nullable|integer|min:1000',
            'price_weekend_high'   => 'nullable|integer|min:1000',
