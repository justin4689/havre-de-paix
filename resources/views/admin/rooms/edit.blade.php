    ...
    <div class="bg-white rounded-xl border shadow-sm p-6" style="border-color: var(--color-border);">
        ...
        <form action="{{ route('admin.rooms.update', $room) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                    <label class="form-label">Prix / nuit — basse saison (FCFA)</label>
                ...
                <div>
                    ...
                    <input type="number" name="price_high_season" value="{{ old('price_high_season', $room->price_high_season) }}" min="0" step="500" class="form-input" placeholder="Déc–Mars · Juil–Août">
                </div>
                <div>
                    <label class="form-label">Week-end basse saison (FCFA)</label>
                    <input type="number" name="price_weekend_low" value="{{ old('price_weekend_low', $room->price_weekend_low) }}" min="0" step="500" class="form-input" placeholder="Ven & sam — défaut : +10 %">
                </div>
                <div>
                    <label class="form-label">Week-end haute saison (FCFA)</label>
                    <input type="number" name="price_weekend_high" value="{{ old('price_weekend_high', $room->price_weekend_high) }}" min="0" step="500" class="form-input" placeholder="Ven & sam — défaut : +10 %">
                </div>
                <div>
