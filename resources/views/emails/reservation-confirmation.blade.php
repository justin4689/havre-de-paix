...
<title>Confirmation de réservation — Havre de Paix</title>
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .logo { display: inline-flex; align-items: center; justify-content: center; width: 48px; height: 48px; background: #F97316; border-radius: 12px; font-weight: 700; color: #fff; font-size: 16px; margin-bottom: 12px; }
  ...
  .greeting { font-size: 16px; margin-bottom: 16px; color: #1E293B; }
  ...
  .total-row { background: #1E293B; border-radius: 8px; padding: 14px 16px; display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; }
  .total-row .label { color: rgba(255,255,255,.7); font-size: 13px; }
  .total-row .value { color: #F97316; font-size: 20px; font-weight: 700; }
  .notice { background: #FEF9C3; border: 1px solid #FDE047; border-radius: 10px; padding: 16px; font-size: 13px; color: #713F12; line-height: 1.6; margin-bottom: 24px; }
  .notice strong { display: block; margin-bottom: 4px; }
  .cta-btn { display: block; background: #F97316; color: #fff !important; text-decoration: none; text-align: center; padding: 14px 32px; border-radius: 10px; font-weight: 600; font-size: 15px; margin-bottom: 12px; }
...
<div class="wrapper">
  <div class="header">
    <div class="logo">HDP</div>
    <h1>Havre de Paix</h1>
    <p>Résidence-Hôtel · Assinie Km 18,75</p>
  </div>
  ...
  <div class="body">
    ...
    <p class="intro">Votre réservation au Havre de Paix a bien été enregistrée. Nous avons hâte de vous accueillir dans notre résidence sur les rives de la lagune.</p>
  ...
  <div class="footer">
    <p>
      Havre de Paix · Assinie Kilomètre 18,75, Côte d'Ivoire<br>
