...
@section('title', 'Confirmation de réservation — Havre de Paix')
@section('logo', '1')
@section('heading', 'Havre de Paix')
@section('subheading', 'Résidence-Hôtel · Assinie')
...
@section('content')
    ...
    <p class="intro">
        Votre réservation à le Havre de Paix a bien été enregistrée.
        Nous avons hâte de vous accueillir dans notre havre de calme et de verdure,
        au bord de la lagune d'Assinie.
    </p>
...
@section('footer')
    <p>
        Havre de Paix · Route d'Assinie, Kilomètre 18,75 — Côte d'Ivoire<br>
        <a href="mailto:{{ config('mail.hotel_email') }}">{{ config('mail.hotel_email') }}</a> · +225 07 00 00 00 00<br><br>
