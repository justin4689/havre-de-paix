...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .message-box { background: #F8FAFC; border-radius: 10px; padding: 16px; border: 1px solid #E2E8F0; font-size: 14px; color: #1E293B; line-height: 1.7; white-space: pre-line; }
...
<div class="wrapper">
  <div class="header">
    ...
    <p>Havre de Paix — Formulaire de contact</p>
  </div>
  <div class="body">
    <div class="meta">
  ...
  <div class="footer">
    Havre de Paix · Assinie Km 18,75, Côte d'Ivoire · Message reçu via le formulaire de contact du site web.
  </div>
</div>
</body>
</html>
