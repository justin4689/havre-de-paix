...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .cta { display: block; background: #F97316; color: #fff !important; text-decoration: none; text-align: center; padding: 13px 28px; border-radius: 10px; font-weight: 600; font-size: 14px; margin-bottom: 20px; }
...
<div class="wrapper">
  ...
  <div class="body">
    ...
    <p style="font-size:14px;color:#64748B;line-height:1.7;margin-bottom:20px;">
      Nous espérons avoir l'occasion de vous accueillir prochainement au Havre de Paix. N'hésitez pas à effectuer une nouvelle réservation sur notre site.
    </p>

    <a href="{{ route('rooms.index') }}" class="cta">Découvrir nos chambres</a>
  </div>
  <div class="footer">
    Havre de Paix · Assinie Km 18,75, Côte d'Ivoire<br>
