...
<title>@yield('title', 'Havre de Paix')</title>
<style>
...
<div class="wrapper">
    <div class="header" style="background: @yield('accent', '#0B1215');">
        @hasSection('logo')
        <img src="{{ asset('images/logo-dashboard.png') }}" alt="Havre de Paix" width="80" height="80" class="logo-img">
        @endif
        <h1>@yield('heading')</h1>
    ...
    <div class="footer">
        ...
        <p>
            ...
            <a href="mailto:{{ config('mail.hotel_email') }}">{{ config('mail.hotel_email') }}</a> · +225 07 00 00 00 00
        </p>
        @show
    </div>
</div>
