...
<head>
    ...
    <title>@yield('title', 'Havre de Paix') — Résidence-Hôtel · Assinie</title>
    <meta name="description" content="@yield('description', __('Havre de Paix, résidence-hôtel au bord de la lagune d\'Assinie (Km 18,75), Côte d\'Ivoire. Réservez en ligne, confirmation instantanée, paiement à l\'arrivée.'))">

    {{-- Open Graph --}}
    <meta property="og:title" content="@yield('title', 'Havre de Paix')">
    ...
    <script type="application/ld+json">
    {
        ...
        "name": "Havre de Paix",
        "description": "Résidence-hôtel au bord de la lagune d'Assinie, Côte d'Ivoire.",
        "url": "{{ url('/') }}",
        "address": {
            "@@type": "PostalAddress",
            "streetAddress": "Assinie Kilomètre 18,75",
...
<body class="antialiased" style="font-family: var(--font-sans); background-color: var(--color-snow); color: var(--color-navy);">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16 lg:h-20">
                    ...
                    <a href="{{ route('home') }}" class="flex items-center gap-3 group">
                        <img src="{{ asset('images/logo.png') }}" alt="Havre de Paix — Résidence-Hôtel, Assinie"
                             class="w-14 h-14 lg:w-[4.25rem] lg:h-[4.25rem] rounded-full bg-white object-contain p-1 shadow-lg ring-2 transition-transform group-hover:scale-105"
                             style="--tw-ring-color: rgba(232,114,12,0.35);">
                        <div>
                            <div class="brand-name text-lg lg:text-xl leading-none transition-colors" :style="scrolled || open ? 'color: var(--color-navy)' : 'color: white'">Havre de Paix</div>
                            <div class="text-[11px] uppercase tracking-[0.18em] leading-none mt-1 transition-colors" :style="scrolled || open ? 'color: var(--color-slate)' : 'color: rgba(255,255,255,0.8)'">Résidence-Hôtel · Assinie</div>
                        </div>
                    </a>
    ...
    <footer style="background-color: var(--color-navy); color: rgba(255,255,255,0.8);">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                ...
                <div class="lg:col-span-2">
                    <div class="flex items-center gap-4 mb-4">
                        <img src="{{ asset('images/logo.png') }}" alt="Havre de Paix — Résidence-Hôtel, Assinie"
                             class="w-20 h-20 rounded-full bg-white object-contain p-1 shadow-lg">
                        <div class="text-[11px] uppercase tracking-[0.18em] leading-relaxed" style="color: rgba(255,255,255,0.6);">
                            Résidence-Hôtel<br>Assinie · Km 18,75
                        </div>
                    </div>
                    <p class="text-sm leading-relaxed max-w-xs" style="color: rgba(255,255,255,0.6);">
                        {{ __('Résidence-hôtel les pieds dans la lagune, à Assinie. Piscine à débordement, jardins et chambres climatisées : un vrai havre de paix.') }}
                    </p>
                    <div class="flex gap-3 mt-5">
                        <a href="https://wa.me/{{ config('hotel.whatsapp') }}" class="w-9 h-9 rounded-full flex items-center justify-center transition-colors" style="background-color: rgba(255,255,255,0.1);" aria-label="WhatsApp">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm" style="color: rgba(255,255,255,0.6);">
                        ...
                        <li class="flex items-center gap-2">
                            ...
                            <span class="break-all">reception@havredepaix-assinie.com</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            {{-- Wordmark géant --}}
            <div class="mt-12 -mb-4 overflow-hidden" aria-hidden="true">
                <p class="footer-wordmark text-center">Havre de Paix</p>
            </div>

            <div class="border-t mt-6 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs" style="border-color: rgba(255,255,255,0.1); color: rgba(255,255,255,0.4);">
                <p>© {{ date('Y') }} · Assinie, Côte d'Ivoire — {{ __('Tous droits réservés.') }}</p>
