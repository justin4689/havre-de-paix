...
<div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: false }">
    ...
    <aside class="fixed inset-y-0 left-0 z-50 flex flex-col w-64 shrink-0 shadow-lg transform transition-transform duration-200 lg:static lg:translate-x-0"
        ...
        {{-- Logo --}}
        <div class="flex flex-col items-center gap-3 px-6 py-6 border-b" style="border-color: rgba(255,255,255,0.1);">
            <img src="{{ asset('images/logo.png') }}" alt="Havre de Paix"
                 class="w-24 h-24 rounded-full bg-white object-contain p-1 shadow-lg ring-2"
                 style="--tw-ring-color: rgba(232,114,12,0.4);">
            <div class="text-center">
                <div class="text-white text-base" style="font-family: var(--font-serif); font-weight: 600;">Havre de Paix</div>
                <div class="text-xs mt-0.5" style="color: rgba(255,255,255,0.5);">Back-office</div>
            </div>
        </div>
        ...
        <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto">
            ...
            $navItems = [
                ...
                ['route' => 'admin.categories.index', 'label' => 'Catégories', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/>'],
