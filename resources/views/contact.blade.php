    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 py-16">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
                ...
                <div class="space-y-5">
                    @foreach ([
                        ['icon' => 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z', 'title' => 'Adresse', 'text' => 'Cocody, Abidjan<br>Côte d\'Ivoire, Afrique de l\'Ouest'],
                        ...
                        ['icon' => 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', 'title' => 'Email', 'text' => 'contact@residencehotelcascades.com'],
                ...
                {{-- WhatsApp --}}
                <div class="mt-8">
                    <a href="https://wa.me/2250000000000?text=Bonjour,%20je%20souhaite%20des%20informations%20sur%20la%20R%C3%A9sidence%20H%C3%B4tel%20Cascades"
