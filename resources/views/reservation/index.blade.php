...
@section('title', __('Finaliser ma réservation — Havre de Paix'))
                ...
                <div class="bg-white rounded-2xl shadow-sm border overflow-hidden" style="border-color: var(--color-border);">
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex justify-between text-sm mb-2" style="color: var(--color-navy);">
                            <span class="underline">{{ __('à partir de') }} {{ number_format($room->price_per_night, 0, ',', ' ') }} FCFA × {{ $nights }} {{ trans_choice('nuit|nuits', $nights) }}</span>
                        ...
                        <div class="flex justify-between text-sm mb-2" style="color: {{ $adjustment > 0 ? 'var(--color-navy)' : '#16a34a' }};">
                            <span class="underline">{{ $adjustment > 0 ? __('Ajustement saison / week-end') : __('Réduction appliquée') }}</span>
