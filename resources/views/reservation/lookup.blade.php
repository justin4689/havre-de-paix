...
@section('title', __('Retrouver ma réservation — Havre de Paix'))
@section('description', __('Consultez ou annulez votre réservation à le Havre de Paix avec votre référence (HDP-AAAA-XXXX).'))
...
<div class="pt-24 pb-20 min-h-screen px-4 sm:px-6" style="background-color: var(--color-snow);">
    <div class="max-w-md mx-auto">
        ...
        <p class="text-center text-xs mt-5 leading-relaxed" style="color: var(--color-slate);">
            {{ __("Référence introuvable ? Elle figure dans l'objet de votre email de confirmation (format HDP-AAAA-XXXX).") }}<br>
