@extends('layouts.app')
@section('title', __('Havre de Paix — Résidence-Hôtel à Assinie'))
@section('description', 'Découvrez le Havre de Paix : résidence-hôtel à Assinie Kilomètre 18,75, Côte d\'Ivoire. Chambres, suites et duplex au bord de la lagune Aby. Tout ce qu\'il faut savoir avant votre séjour.')
...
<section class="relative min-h-[70vh] flex items-center overflow-hidden">
    <x-hero-slideshow :images="[
        ['src' => 'images/site/hero-lagune-piscine.jpg', 'alt' => 'La piscine à débordement face à la lagune d\'Assinie et sa pirogue'],
        ['src' => 'images/site/hero-facade-hotel.jpg',   'alt' => 'La façade de la résidence, vue depuis l\'entrée du domaine'],
        ['src' => 'images/site/hero-palmiers.jpg',       'alt' => 'Les palmiers penchés au-dessus du bassin à débordement'],
        ['src' => 'images/site/hero-pavillon-nuit.jpg',  'alt' => 'Le pavillon vitré illuminé à la tombée de la nuit'],
    ]" />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            <div>
                ...
                <div class="space-y-4 text-base leading-relaxed" style="color: var(--color-slate);">
                    <p>
                        {!! __("Posé entre la lagune Aby et l'océan, le <strong>Havre de Paix</strong> est né d'une vision simple : offrir un refuge de sérénité au kilomètre 18,75 de la route d'Assinie, là où le temps ralentit.") !!}
                    </p>
                    <p>
                        {{ __("Chaque détail de notre résidence-hôtel a été pensé pour s'intégrer au cadre naturel exceptionnel qui nous entoure : la piscine à débordement se fond dans la lagune, le pavillon vitré s'ouvre sur l'eau, les jardins invitent à la contemplation.") }}
                    </p>
                    <p>
                        {!! __("À environ <strong>1h30 d'Abidjan</strong>, notre adresse est idéale pour un week-end de déconnexion comme pour des vacances en famille — la plage océane d'Assinie-Mafia est à quelques minutes.") !!}
                    </p>
                </div>
            ...
            <div class="relative">
                <div class="aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl">
                    <img src="{{ asset('images/site/piscine-palmiers.jpg') }}"
                         alt="La piscine à débordement du Havre de Paix bordée de palmiers"
                ...
                <div class="absolute -bottom-6 -left-6 bg-white rounded-2xl p-5 shadow-xl border" style="border-color: var(--color-border);">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs" style="color: var(--color-slate);">{{ __('La lagune à quelques pas des chambres') }}</p>
                        </div>
                    </div>
                </div>
            </div>
...
<section id="equipements" class="scroll-mt-32 py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-14">
            ...
            <p class="section-subtitle max-w-2xl mx-auto">{{ __('Tout le confort pour un séjour inoubliable au bord de la lagune.') }}</p>
        </div>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 mb-14">
            @foreach ([
                ...
                ['icon' => 'M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064', 'label' => __('Piscine à débordement'), 'desc' => __('Ouverte à tous nos hôtes')],
                ...
                ['icon' => 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', 'label' => __('Petit-déjeuner inclus'), 'desc' => __('Servi au pavillon face à la lagune')],
        ...
        {{-- Bloc spécial piscine + jardins --}}
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="relative rounded-2xl overflow-hidden h-56 group">
                <img src="{{ asset('images/site/jardin.jpg') }}" alt="Les jardins verdoyants de la résidence" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                ...
                <div class="absolute bottom-4 left-4">
                    ...
                    <p class="text-white/70 text-sm">{{ __('Pelouses et palmiers entre les chambres et la lagune') }}</p>
                </div>
            </div>
            <div class="relative rounded-2xl overflow-hidden h-56 group">
                <img src="{{ asset('images/site/pavillon-exterieur.jpg') }}" alt="Le pavillon vitré face à la lagune" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                <div class="absolute inset-0" style="background: linear-gradient(to top, rgba(11,18,21,0.8) 0%, transparent 60%);"></div>
                <div class="absolute bottom-4 left-4">
                    <p class="text-white font-bold text-lg" style="font-family: var(--font-serif);">{{ __('Le pavillon vitré') }}</p>
                    <p class="text-white/70 text-sm">{{ __('Petit-déjeuner face à la lagune, matin après matin') }}</p>
                </div>
            </div>
        </div>
    </div>
...
<section id="galerie" class="scroll-mt-32 py-20" style="background-color: var(--color-snow);">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-14">
            ...
            <h2 class="section-title">{{ __('Galerie de le Havre de Paix') }}</h2>
        </div>

        @php
        // Deux ensembles qui alternent en fondu : le domaine, puis les chambres.
        $gallerySets = [
            [
                ...
                ['img' => 'site/hero-piscine-nuit-arbre.jpg', 'alt' => 'La piscine illuminée de nuit et son arbre éclairé'],
                ['img' => 'site/terrasse-nuit.jpg',       'alt' => 'La terrasse du pavillon en soirée'],
            ],
            [
                ['img' => 'rooms/premium-1-1.jpg',      'alt' => 'La Chambre Premium et son lit king size en tissus wax'],
                ['img' => 'rooms/standard-1-1.jpg',     'alt' => 'La Chambre Standard et sa literie aux tons verts'],
                ['img' => 'rooms/standard-2-1.jpg',     'alt' => 'La Chambre Standard en palette bleu lagune'],
                ['img' => 'rooms/suite-1.jpg',          'alt' => 'La Suite et son plafond lumineux'],
                ['img' => 'rooms/suite-premium-1.jpg',  'alt' => 'La Suite Premium et son comptoir bar'],
                ['img' => 'rooms/duplex-1.jpg',         'alt' => 'Une chambre du Duplex familial'],
                ['img' => 'rooms/premium-2-1.jpg',      'alt' => 'La Chambre Premium en palette turquoise'],
                ['img' => 'rooms/suite-3.jpg',          'alt' => 'La salle de bain avec baignoire de la Suite'],
                ['img' => 'rooms/premium-1-3.jpg',      'alt' => 'Le coin détente de la Chambre Premium'],
            ],
        ];
        ...
        <div x-data="{ gallerySet: 0, lightbox: null, imgs: {{ json_encode(array_map(fn ($p) => ['s' => asset('images/' . $p['img']), 'a' => $p['alt']], $galleryFlat)) }} }"
            ...
            <div x-show="lightbox !== null" x-transition.opacity
                ...
                <img :src="lightbox !== null ? imgs[lightbox].s : ''" :alt="lightbox !== null ? imgs[lightbox].a : ''" class="max-w-5xl max-h-[85vh] w-full object-contain rounded-xl" loading="lazy">
            ...
            <a href="{{ route('rooms.show', $room->slug) }}" class="card group no-underline block">
                <div class="relative h-52 overflow-hidden">
                    ...
                    <div class="absolute top-3 left-3 flex gap-2 flex-wrap">
                        <span class="badge text-xs">{{ __($room->category_label) }}</span>
                    </div>
                </div>
                <div class="p-5">
                    <h3 class="font-bold text-base mb-2 group-hover:text-orange-500 transition-colors" style="font-family: var(--font-serif); color: var(--color-navy);">{{ __($room->name) }}</h3>
...
<section id="situation" class="scroll-mt-32 py-20" style="background-color: var(--color-snow);">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-14">
            ...
            <p class="section-subtitle max-w-xl mx-auto">{{ __('Assinie, Kilomètre 18,75 — au bord de la lagune Aby, à environ 1h30 d\'Abidjan.') }}</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            ...
            <div class="rounded-2xl overflow-hidden shadow-lg h-80 lg:h-full min-h-72 border" style="border-color: var(--color-border);">
                <iframe
                    src="https://maps.google.com/maps?q=Assinie-Mafia,+C%C3%B4te+d%27Ivoire&t=&z=12&ie=UTF8&iwloc=&output=embed"
                    width="100%" height="100%"
                    style="border:0; min-height: 320px;"
                    allowfullscreen="" loading="lazy"
                    referrerpolicy="no-referrer-when-downgrade"
                    title="Carte Havre de Paix">
                </iframe>
            </div>
            ...
            <div class="space-y-5">
                <div class="bg-white rounded-2xl p-6 border shadow-sm" style="border-color: var(--color-border);">
                    ...
                    <ol class="space-y-3">
                        @foreach ([
                            __('Depuis Abidjan, prendre l\'autoroute A100 direction Grand-Bassam'),
                            __('Poursuivre sur la côtière vers Bonoua, puis suivre la direction Assinie / Assouindé'),
                            __('Sur la route d\'Assinie, rouler jusqu\'au kilomètre 18,75 — le Havre de Paix est indiqué par son enseigne'),
                            __('Parking disponible dans l\'enceinte de la résidence'),
                        ] as $i => $step)
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="bg-white rounded-xl p-4 border shadow-sm text-center" style="border-color: var(--color-border);">
                        <div class="text-2xl font-bold mb-1" style="color: var(--color-orange); font-family: var(--font-serif);">~1h30</div>
                        <p class="text-xs" style="color: var(--color-slate);">{{ __("D'Abidjan (aéroport FHB)") }}</p>
                    </div>
                    <div class="bg-white rounded-xl p-4 border shadow-sm text-center" style="border-color: var(--color-border);">
                        <div class="text-2xl font-bold mb-1" style="color: var(--color-orange); font-family: var(--font-serif);">~10 min</div>
                        <p class="text-xs" style="color: var(--color-slate);">{{ __("De la plage d'Assinie-Mafia") }}</p>
                    </div>
                ...
                <a href="https://wa.me/{{ config('hotel.whatsapp') }}?text=Bonjour,%20je%20souhaite%20avoir%20des%20informations%20sur%20le%20Havre%20de%20Paix%20%C3%A0%20Assinie."
                   ...
                   class="btn-primary w-full py-3.5 text-sm">
                    ...
                    {{ __('Nous contacter sur WhatsApp') }}
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
            @foreach ([
                ...
                [
                    ...
                    'title' => __('Paiement'),
                    'items' => [__('Règlement intégral à l\'arrivée'), __('Espèces ou virement acceptés'), __('Caution éventuelle à l\'arrivée')],
                ],
                [
                ...
                [
                    ...
                    'items' => [__('Enfants bienvenus'), __('Lit bébé disponible (sur demande)'), __('Tarif enfant -12 ans : gratuit'), __('Piscine commune en accès libre')],
                ],
                [
        ...
        <div class="space-y-3" x-data="{ open: null }">
            @foreach ([
                ...
                [
                    ...
                    'a' => __('Absolument. Les enfants sont les bienvenus. Des lits bébé sont disponibles sur demande. Les enfants de moins de 12 ans séjournent gratuitement en partageant le lit des parents.'),
                ],
                [
                ...
                [
                    ...
                    'a' => __('Le restaurant complet ouvrira prochainement. En attendant, le petit-déjeuner est inclus dans chaque séjour et servi au pavillon vitré face à la lagune. De nombreux restaurants d\'Assinie se trouvent à quelques minutes.'),
                ],
            ] as $i => $faq)
...
<section class="relative py-24 overflow-hidden">
    <img src="{{ asset('images/site/piscine-nuit.jpg') }}"
         alt="La piscine du Havre de Paix illuminée de nuit"
    ...
    <div class="relative z-10 text-center text-white max-w-2xl mx-auto px-4 sm:px-6">
        ...
        <h2 class="text-4xl sm:text-5xl font-bold mb-6" style="font-family: var(--font-serif);">
            {{ __('Réservez votre chambre') }}
        </h2>
        <p class="text-lg text-white/80 mb-8">
            {{ __("Confirmation instantanée par email. Paiement à l'arrivée uniquement. Annulation gratuite jusqu'à 48h avant.") }}
        </p>
