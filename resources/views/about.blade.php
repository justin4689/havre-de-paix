...
<section id="equipements" class="scroll-mt-32 py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="relative rounded-2xl overflow-hidden h-56 group">
                <img src="{{ asset('images/beach-access.jpg') }}" alt="Les jardins de la résidence" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                <div class="absolute inset-0" style="background: linear-gradient(to top, rgba(11,18,21,0.8) 0%, transparent 60%);"></div>
                <div class="absolute bottom-4 left-4">
                    <p class="text-white font-bold text-lg" style="font-family: var(--font-serif);">Des jardins luxuriants</p>
                    <p class="text-white/70 text-sm">Détente à l'ombre des palmiers</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            ...
            <div class="rounded-2xl overflow-hidden shadow-lg h-80 lg:h-full min-h-72 border" style="border-color: var(--color-border);">
                <iframe
                    ...
                    title="Carte Résidence Hôtel Cascades">
                </iframe>
            </div>
            ...
            <div class="space-y-5">
                ...
                <a href="https://wa.me/2250000000000?text=Bonjour,%20je%20souhaite%20avoir%20des%20informations%20sur%20la%20R%C3%A9sidence%20H%C3%B4tel%20Cascades."
...
<section class="relative py-24 overflow-hidden">
    <img src="{{ asset('images/terrace.jpg') }}"
         alt="Terrasse Résidence Hôtel Cascades"
         class="absolute inset-0 w-full h-full object-cover">
